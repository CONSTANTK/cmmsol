...
<html lang="en">
<head>
    <title>CMM Solution Limited</title>
    <meta charset="utf-8">
...
<div class="hero-wrap js-fullheight" style="{{asset('itsol/background-image:url(images/bg_1.jpg);')}}" data-stellar-background-ratio="0.5">
...
<section class="ftco-section">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <img src="{{asset('itsol/images/services.svg')}}" class="img-fluid" alt="">
            </div>
            <div class="col-md-4">
                <div class="services-2 text-center">
                    <div class="icon">
    ...
    <div class="container">
        <div class="row no-gutters d-flex">
            <div class="col-md-6 d-flex">
                <div class="img d-flex align-self-stretch" style="{{asset('itsol/background-image:url(images/about.jpg);')}}"></div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 order-md-last">
                ...
                <div class="d-flex mt-3">
                    <div class="img img-2 mr-md-2 w-100" style="{{asset('itsol/background-image:url(images/about-1.jpg);')}}"></div>
                    <div class="img img-2 ml-md-2 w-100" style="{{asset('itsol/background-image:url(images/about-2.jpg);')}}"></div>
                </div>
            </div>
...
<section class="ftco-section ftco-no-pb testimony-section" style="{{asset('itsol/background-image: url(images/bg_1.jpg);')}}">
        ...
        <div class="row ftco-animate">
            <div class="col-md-12 testimonial">
                <div class="carousel-testimony owl-carousel ftco-owl">
                    <div class="item">
                        <div class="testimony-wrap d-flex align-items-stretch" style="{{asset('itsol/background-image: url(images/testimony-1.jpg);')}}">
                            <div class="overlay"></div>
                            <div class="text">
                                <div class="line"></div>
                    ...
                    <div class="item">
                        <div class="testimony-wrap d-flex align-items-stretch" style="{{asset('itsol/background-image: url(images/testimony-2.jpg);')}}">
                            <div class="overlay"></div>
                            <div class="text">
                                <div class="line"></div>
                                <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    ...
                    <div class="item">
                        <div class="testimony-wrap d-flex align-items-stretch" style="{{asset('itsol/background-image: url(images/testimony-3.jpg);')}}">
                            <div class="overlay"></div>
                            <div class="text">
                                <div class="line"></div>
                                <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    ...
                    <div class="item">
                        <div class="testimony-wrap d-flex align-items-stretch" style="{{asset('itsol/background-image: url(images/testimony-4.jpg);')}}">
                            <div class="overlay"></div>
                            <div class="text">
                                <div class="line"></div>
                                <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    ...
                    <div class="item">
                        <div class="testimony-wrap d-flex align-items-stretch" style="{{asset('itsol/background-image: url(images/testimony-5.jpg);')}}">
                            <div class="overlay"></div>
                            <div class="text">
                                <div class="line"></div>
                                <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
        ...
        <div class="row d-flex">
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry justify-content-end">
                    <a href="{{asset('itsol/blog-single.html')}}" class="block-20" style="{{asset('itsol/background-image: url(images/image_1.jpg);')}}">
                    </a>
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry justify-content-end">
                    <a href="{{asset('itsol/blog-single.html')}}" class="block-20" style="{{asset('itsol/background-image: url(images/image_2.jpg);')}}">
                    </a>
                    <div class="text mt-3 float-right d-block">
                        <div class="d-flex align-items-center pt-2 mb-4 topp">
                            <div class="one">
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry">
                    <a href="{{asset('itsol/blog-single.html')}}" class="block-20" style="{{asset('itsol/background-image: url(images/image_3.jpg);')}}">
                    </a>
                    <div class="text mt-3 float-right d-block">
                        <div class="d-flex align-items-center pt-2 mb-4 topp">
                            <div class="one">
...
<section class="ftco-appointment ftco-section img" style="{{asset('itsol/background-image: url(images/bg_2.jpg);')}}">
    <div class="overlay"></div>
    <div class="container">
        <div class="row">
